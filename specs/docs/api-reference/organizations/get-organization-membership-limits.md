...
````yaml https://api.xata.tech/openapi.json get /organizations/{organizationID}/membership-limits
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/membership-limits:
    ...
    get:
      ...
      description: >-
        Retrieves the membership limits for the specified organization (maximum
