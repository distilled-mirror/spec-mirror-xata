...
````yaml https://api.xata.tech/openapi.json get /organizations
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations:
    ...
    description: >-
      This endpoint enables creating and listing organizations within Xata.
      Organizations are the top-level entity that contains projects, branches,
      and team members.
    get:
      tags:
        - Organizations
      ...
      description: >-
        Retrieve the list of all organizations the authenticated user belongs
        to, including their IDs and names. This endpoint allows users to view
        all organizations they have access to.
