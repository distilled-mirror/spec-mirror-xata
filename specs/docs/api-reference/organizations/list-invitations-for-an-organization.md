...
````yaml https://api.xata.tech/openapi.json get /organizations/{organizationID}/invitations
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/invitations:
    ...
    get:
      ...
      description: >-
        Retrieve all invitations for an organization with optional filtering by
        status, email, and name.
