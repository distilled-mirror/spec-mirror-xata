...
````yaml https://api.xata.tech/openapi.json get /organizations/{organizationID}/projects/{projectID}
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/projects/{projectID}:
    ...
    get:
      ...
      description: >-
        Retrieves detailed information about a specific project by its ID within
