...
````yaml https://api.xata.tech/openapi.json delete /organizations/{organizationID}/projects/{projectID}
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/projects/{projectID}:
    ...
    delete:
      ...
      description: >-
        Permanently deletes a specific project by its ID and all associated
        resources including branches and databases. This action cannot be
        undone.
