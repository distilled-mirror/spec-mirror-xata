...
````yaml https://api.xata.tech/openapi.json get /organizations/{organizationID}/images
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/images:
    ...
    description: >-
      Endpoints for retrieving available images for creating branches within an
      organization.
    get:
      tags:
        - Projects
