...
````yaml https://api.xata.tech/openapi.json get /organizations/{organizationID}/projects
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/projects:
    ...
    get:
      ...
      description: >-
        Retrieves a list of all projects within the specified organization that
