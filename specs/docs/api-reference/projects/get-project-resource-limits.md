...
````yaml https://api.xata.tech/openapi.json get /organizations/{organizationID}/projects/{projectID}/limits
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/projects/{projectID}/limits:
    ...
    description: >-
      Endpoint for retrieving the effective resource limits for a specific
      project.
    get:
      tags:
        - Projects
      ...
      description: >-
        Retrieves the effective resource limits for the specified project,
        merging organization-level overrides with any project-specific
        overrides.
