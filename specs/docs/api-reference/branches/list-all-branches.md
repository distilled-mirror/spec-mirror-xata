...
````yaml https://api.xata.tech/openapi.json get /organizations/{organizationID}/projects/{projectID}/branches
openapi: 3.0.0
info:
  title: Xata API
...
paths:
  /organizations/{organizationID}/projects/{projectID}/branches:
    ...
    get:
      ...
      description: >-
        Retrieves a list of all branches within the specified project, including
        their metadata, region, and access settings.
