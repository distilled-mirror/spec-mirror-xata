...
![kafka tutorial](https://raw.githubusercontent.com/xataio/pgstream/main/docs/img/pgstream_tutorial_kafka.svg)
...
Further configuration can be provided to optimize the performance of the snapshot process. For more information, check the [snapshot tutorial](/docs/opensource/pgstream/docs/tutorials/postgres_snapshot).
...
This configuration is the same as the one from the tutorial for PostgreSQL to PostgreSQL replication. More details [here](/docs/opensource/pgstream/docs/tutorials/postgres_to_postgres#processor).
...
This configuration is the same as the one from the tutorial for PostgreSQL to OpenSearch replication. More details [here](/docs/opensource/pgstream/docs/tutorials/postgres_to_opensearch#processor).
...
All other operations will be cascaded to both targets accordingly. For more details on each individual target, check out the [PostgreSQL to PostgreSQL replication](/docs/opensource/pgstream/docs/tutorials/postgres_to_postgres) and the [PostgreSQL to OpenSearch replication](/docs/opensource/pgstream/docs/tutorials/postgres_to_opensearch) tutorials.
