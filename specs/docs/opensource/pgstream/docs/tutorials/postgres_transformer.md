...
![transformer tutorial](https://raw.githubusercontent.com/xataio/pgstream/main/docs/img/pgstream_tutorial_transformer.svg)

### Requirements

* A source PostgreSQL database
* A target PostgreSQL database
* pgstream (see [installation](/docs/opensource/pgstream/docs/cli#installation) instructions for more details)

### Demo

<iframe className="w-full aspect-video rounded-xl" src="https://www.youtube.com/embed/6aHzmv1h_48" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
The listener configuration will be the same as the one in the PostgreSQL to PostgreSQL replication tutorial. Check the details [here](/docs/opensource/pgstream/docs/tutorials/postgres_to_postgres#listener).
...
The processor configuration will be the same as the one in the PostgreSQL to PostgreSQL replication tutorial. Check the details [here](/docs/opensource/pgstream/docs/tutorials/postgres_to_postgres#processor).
...
The transformer rules follow the pattern defined in the [transfomer section](/docs/opensource/pgstream/docs/transformers#transformation-rules) of the documentation. To see all the transformers currently supported, check out the [transformers section](/docs/opensource/pgstream/docs/transformers#supported-transformers). For this tutorial we'll be using the following transformations:
...
To see all the transformers currently supported, check out the [transformers section](/docs/opensource/pgstream/docs/transformers#supported-transformers).
...
* **Error:** `Transformation rules not applied`
  ...
  * Validate the syntax of the transformer rules using the [pgstream documentation](/docs/opensource/pgstream/docs/transformers#transformation-rules).
