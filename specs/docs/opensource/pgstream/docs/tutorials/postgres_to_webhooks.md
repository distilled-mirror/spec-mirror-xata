...
![pg2webhooks tutorial](https://raw.githubusercontent.com/xataio/pgstream/main/docs/img/pgstream_tutorial_pg2webhooks.svg)
...
<iframe className="w-full aspect-video rounded-xl" src="https://www.youtube.com/embed/fewe85P5ktk" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
Further configuration can be provided to optimize the performance of the snapshot process. For more information, check the [snapshot tutorial](/docs/opensource/pgstream/docs/tutorials/postgres_snapshot#listener).
...
```sh theme={null}
# with initialization
pgstream run -c pg2webhook_tutorial.env --init --log-level trace
